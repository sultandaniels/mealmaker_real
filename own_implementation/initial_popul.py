...
def rand_prep(ing, ing_list, agroup_x_ing, prep_thresh):
    ...
    """
    return prep_ratio(ing, ing_list, agroup_x_ing) > np.random.normal(prep_thresh, 0.7)
...
def rand_heat(ing, ing_list, agroup_x_ing, heat_thresh):
    ...
    """
    return heat_ratio(ing, ing_list, agroup_x_ing) > np.random.normal(heat_thresh, 0.7)
